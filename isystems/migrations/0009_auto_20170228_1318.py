# -*- coding: utf-8 -*-
# Generated by Django 1.10.4 on 2017-02-28 03:18
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('isystems', '0008_auto_20170222_1556'),
    ]
    ...
    operations = [
        migrations.AddField(
            model_name='status',
            name='cost',
            field=djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='RUB', max_digits=10, verbose_name='Стоимость этапа'),
        ),
        migrations.AddField(
            model_name='status',
            name='cost_currency',
