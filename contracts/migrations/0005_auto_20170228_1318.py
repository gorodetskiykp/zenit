...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('contracts', '0004_auto_20170228_1223'),
    ]
    ...
    operations = [
        migrations.AddField(
            model_name='contract',
            name='cost',
            field=djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='RUB', max_digits=10, verbose_name='Стоимость'),
        ),
        migrations.AddField(
            model_name='contract',
            name='cost_currency',
