# -*- coding: utf-8 -*-
# Generated by Django 1.10.4 on 2017-02-28 03:25
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('contracts', '0005_auto_20170228_1318'),
    ]
    ...
    operations = [
        migrations.AddField(
            model_name='contract',
            name='nds',
            field=djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='RUB', max_digits=10, verbose_name='в т.ч. НДС 18%'),
        ),
        migrations.AddField(
            model_name='contract',
            name='nds_currency',
